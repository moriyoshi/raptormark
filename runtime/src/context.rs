...
/// and was not (.agents/docs/JOURNAL.md). An instrument verbose enough to
...
impl EcvContext {
    ...
    pub fn new(
        ...
        let library_units = programs.library_indices();
    ...
    pub fn shm_reserve(&mut self, len: u64) -> Option<u64> {
        self.shm_window.reserve(len, self.arena.mmap_cur)
    }
