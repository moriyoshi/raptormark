...
// construction (measured: .ecv.funcs 62,240 bytes for echo against 62,400 for
// cat). A key over every ALLOCATED section from that base swept all of it in, so
